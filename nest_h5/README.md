...
测试部署：
1. 配置测试环境 .env.development
    a. 接口api: VITE_APP_API_BASE_URL
2. 安装库: npm i --force
3. 测试环境打包: npm run build:dev
nod
正式部署:
1. 配置正式环境 .env.production
    a. 接口api: VITE_APP_API_BASE_URL
2. 安装库: npm i --force
3. 正式环境打包: npm run build


基于脚手架: https://github.com/easy-temps/vue3-vant-mobile
